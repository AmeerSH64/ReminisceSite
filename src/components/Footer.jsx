      ...
      <div className='container px-6 mx-auto'>
        <div className='flex flex-col md:flex-row items-center justify-between gap-8'>
          <div className='flex gap-4 text-center md:text-left'>
            <a href="#home">
              <img className='logo' src="/logo-main.png" alt="Reminisce Logo" />
            </a>
          ...
          <div className='flex items-center gap-4'>
            {socials.map((social) => (
              ...
              className='p-2 text-secondary rounded-full hover:text-primary hover:bg-navbar-2 transition-colors cursor-pointer'>
